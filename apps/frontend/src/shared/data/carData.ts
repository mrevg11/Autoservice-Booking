...
export const CAR_DATA: CarMake[] = [
  ...
  },
  {
    make: 'ВАЗ',
    models: [
      { name: '2101 «Жигулі»', years: range(1970, 1988) },
      { name: '2102 «Жигулі»', years: range(1971, 1986) },
      { name: '2103 «Жигулі»', years: range(1972, 1984) },
      { name: '2104 «Жигулі»', years: range(1984, 2012) },
      { name: '2105 «Жигулі»', years: range(1980, 2010) },
      { name: '2106 «Жигулі»', years: range(1976, 2006) },
      { name: '2107 «Жигулі»', years: range(1982, 2012) },
      { name: '2108 «Самара»', years: range(1984, 2013) },
      { name: '2109 «Самара»', years: range(1987, 2011) },
      { name: '21099 «Самара»', years: range(1990, 2011) },
      { name: '2110', years: range(1995, 2014) },
      { name: '2111', years: range(1998, 2009) },
      { name: '2112', years: range(1999, 2009) },
      { name: '2113 «Самара 2»', years: range(1997, 2013) },
      { name: '2114 «Самара 2»', years: range(1997, 2013) },
      { name: '2115 «Самара 2»', years: range(1997, 2012) },
      { name: '2120 «Надія»', years: range(1998, 2006) },
      { name: '2121 «Нива»', years: range(1977, 2025) },
      { name: '2123 «Нива»', years: range(1998, 2002) },
      { name: 'Granta', years: range(2011, 2025) },
      { name: 'Kalina', years: range(2004, 2018) },
      { name: 'Largus', years: range(2012, 2025) },
      { name: 'Priora', years: range(2007, 2018) },
      { name: 'Vesta', years: range(2015, 2025) },
      { name: 'XRAY', years: range(2015, 2022) },
    ],
  },
  {
    make: 'ZAZ',
